...
?>
    ...
    <div class="col-md-4">
        <h2>Web Design</h2>
         <!-- <img src="images/simplex/templatemo_image_01.jpg" alt="Image 1" class="img-responsive img-rounded img_left" />-->
         <?php 
        echo $this->Html->image(
                'templatemo_image_01.jpg', array('alt' => 'Image 1', 'class' => 'img-responsive img-rounded img_left'
                    ));			
	?>
    ...
    <div class="col-md-4">
        ...
        <?php 
        echo $this->Html->image(
                'templatemo_image_02.jpg', array('alt' => 'Image 2', 'class' => 'img-responsive img-rounded img_left'
                    ));			
	?>
    ...
    <div class="col-md-4">
        ...
        <?php 
        echo $this->Html->image(
                'templatemo_image_03.jpg', array('alt' => 'Image 3', 'class' => 'img-responsive img-rounded img_left'
                    ));			
	?>
